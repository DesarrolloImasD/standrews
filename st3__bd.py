        ...
        while True:
            ...
            try:
                ...
                try:
                    ...
                    consulta = f"INSERT INTO spt.prod (valProd, created_at) VALUES ('{codigoProducto}','{datetime.now().strftime("%Y-%m-%d %H:%M:%S")}')"
                    ...
                    print(datetime.now().strftime("%d-%m-%Y %H:%M:%S")+ " " + codigoProducto + " insertado correctamente.")
